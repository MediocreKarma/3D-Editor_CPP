...
TextInputBox::TextInputBox(const int& areaBegin, const int& areaEnd, const int& height, const int& textColor, const int& fillColor, const int& maxSize) :
                ...
                m_pressedEnter(false), m_mouseclick{-1, -1}, m_text(nullptr) {}
...
void TextInputBox::displayCursor(const MyArray<char, MAX_TEXT_SIZE>& outText, const size_t& from) {
    ...
    line(m_areaBegin + len, m_height - 10, m_areaBegin + len, m_height + 10);
}
